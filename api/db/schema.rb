...
ActiveRecord::Schema.define(version: 0) do
  ...
  create_table "purchase_histories", charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
    t.integer "delivery_type", default: 0, null: false, comment: "配達方法"
    t.integer "delivery_status", default: 0, null: false, comment: "配達状況"
    t.integer "payment_type", default: 0, null: false, comment: "お支払い方法"
    t.integer "payment_status", default: 0, null: false, comment: "お支払い状況"
